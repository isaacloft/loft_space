...
function animate(){
 ...
 .to([".cover1", ".copy1"], .5, {ease: SteppedEase.config(15),x: "0%", y: "0%"})
 .to([".cover2", ".copy2"], .5, {ease: SteppedEase.config(15),x: "0%", y: "0%"},"-=.15")
 .to([".cover3", ".copy3"], .5, {ease: SteppedEase.config(15),x: "0%", y: "0%"},"-=.15")
 .to([".cover4", ".copy4"], .5, {ease: SteppedEase.config(10),x: "0%", y: "0%"},"-=.15")




 .to([".body",".head"], .5, {opacity:1, ease: Power2.easeInOut},"-=.35")

 .to([".body"], 1, {y:-5, ease: Power4.easeInOut},"-=.5")
 .to([".head"], 1, {rotation:0, ease: Power4.easeInOut},"-=.85")
 .to([".body"], .5, {y:-2, ease: Power4.easeInOut},"-=.1")
 .to([".head"], .5, {rotation:2, ease: Power4.easeInOut},"-=.5")

 .to([".body",".head",".cover1",".cover2",".cover3",".cover4"], 0.5, {opacity: 0},"+=2")
 ...
 .to([".ribbon-container1", ".ribbon1"], 0.7, {x: "0%", y: "0%"})
 .to([".ribbon-container2", ".ribbon2"], 0.9, {x: "0%", y: "0%"},"-=0.9")
 ...
 .to([".endframe",".end_copy1"], 0.5, {opacity: 1},"-=.35")
...
function animationRestart(){
  ...
  if (counter > -1) {
    ...
    tlRepeat.to([".last_frame",".last_frame_copy",".cta",".ribbon1",".ribbon2",".ribbon3",".ribbon4"],0.75,{opacity:0,onComplete: test},"+=2");
  }
}
